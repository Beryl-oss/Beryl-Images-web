      ...
      <nav ref={navRef} className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-white/70 bg-white/70 px-4 py-2 shadow-[0_10px_35px_rgba(15,23,42,0.12)] backdrop-blur-[24px] backdrop-saturate-150 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <button
            ...
            className="group relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-white/70 bg-white/70 text-[#264653] shadow-[0_6px_18px_rgba(15,23,42,0.1)] backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-white"
          >
